...
public class PostEditorAnalyticsSession implements Serializable {
    ...
    public void start(@Nullable ArrayList<Object> unsupportedBlocksList, @Nullable Boolean canViewEditorOnboarding) {
        if (!mStarted) {
    ...
    public void end(@Nullable Boolean canViewEditorOnboarding) {
